...
var RevealCountDown =
  ...
  (function() {
    ...
    function initCountDown(currentSlide) {
      ...
      counterRef = currentSlide.querySelector("[data-countdown]"); // getElementsByTagName("countdown")[0];
      if (counterRef === undefined | counterRef === null) return;
      time = counterRef.getAttribute("data-time");
      autostart = counterRef.getAttribute("data-autostart");
      elapsedTime = 0;
